...
dist = setup(
    ...
    url='https://github.com/xiewendan/supervisor-fork',
    project_urls={
        'Changelog': 'https://github.com/xiewendan/supervisor-fork/blob/main/CHANGES.rst',
        'Documentation': 'https://github.com/xiewendan/supervisor-fork/blob/main/README.rst',
        'Issue Tracker': 'https://github.com/xiewendan/supervisor-fork',
    },
